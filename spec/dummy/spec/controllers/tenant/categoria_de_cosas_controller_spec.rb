...
RSpec.describe Tenant::CategoriaDeCosasController, :tpath_cont do
  render_views
  ...
  describe 'POST #create' do
    context 'with valid params' do
      ...
      it 'redirects to the created categoria_de_cosa' do
        post :create, params: { categoria_de_cosa: valid_attributes }
        expect(response).to redirect_to([:tenant, CategoriaDeCosa.last])
      end
    end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'redirects to the categoria_de_cosa' do
        ...
        expect(response).to redirect_to([:tenant, categoria_de_cosa])
      end
    end
  ...
  describe 'DELETE #destroy' do
    ...
    context 'si hay land_on' do
      ...
      it 'redirects to the categoria_de_cosas list' do
        subject
        expect(response).to redirect_to(tenant_categoria_de_cosas_path)
      end
    end
  end
end
